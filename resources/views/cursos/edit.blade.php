            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('codigo') is-invalid @enderror" 
                           id="codigo" name="codigo" value="{{ old('codigo', $curso->codigo) }}" required>
                    @error('codigo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('duracao_semestres') is-invalid @enderror" 
                           id="duracao_semestres" name="duracao_semestres" 
                           value="{{ old('duracao_semestres', $curso->duracao_semestres) }}" 
                           min="1" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('carga_horaria_total') is-invalid @enderror" 
                           id="carga_horaria_total" name="carga_horaria_total" 
                           value="{{ old('carga_horaria_total', $curso->carga_horaria_total) }}" 
                           min="1" required>
