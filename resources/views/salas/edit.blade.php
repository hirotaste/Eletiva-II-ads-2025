            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('codigo') is-invalid @enderror" 
                           id="codigo" name="codigo" value="{{ old('codigo', $sala->codigo) }}" required>
                    @error('codigo')
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input type="text" class="form-control @error('nome') is-invalid @enderror" 
                           id="nome" name="nome" value="{{ old('nome', $sala->nome) }}" required>
                    @error('nome')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('capacidade') is-invalid @enderror" 
                           id="capacidade" name="capacidade" value="{{ old('capacidade', $sala->capacidade) }}" 
                           min="1" required>
                    @error('capacidade')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo">
                        ...
                        <option value="sala_aula" {{ old('tipo', $sala->tipo) == 'sala_aula' ? 'selected' : '' }}>Sala de Aula</option>
                        <option value="laboratorio" {{ old('tipo', $sala->tipo) == 'laboratorio' ? 'selected' : '' }}>Laboratório</option>
                        <option value="auditorio" {{ old('tipo', $sala->tipo) == 'auditorio' ? 'selected' : '' }}>Auditório</option>
                    </select>
                    @error('tipo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="possui_projetor" 
                           name="possui_projetor" value="1" {{ old('possui_projetor', $sala->possui_projetor) ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="possui_ar_condicionado" 
                           name="possui_ar_condicionado" value="1" {{ old('possui_ar_condicionado', $sala->possui_ar_condicionado) ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="possui_computadores" 
                           name="possui_computadores" value="1" {{ old('possui_computadores', $sala->possui_computadores) ? 'checked' : '' }}>
