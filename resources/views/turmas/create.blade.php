...
@section('page-title', 'Cadastrar Nova Turma')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('periodo_letivo_id') is-invalid @enderror" id="periodo_letivo_id" name="periodo_letivo_id" required>
                        ...
                        @foreach($periodos as $periodo)
                            <option value="{{ $periodo->id }}" {{ old('periodo_letivo_id') == $periodo->id ? 'selected' : '' }}>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control @error('vagas_total') is-invalid @enderror" 
                           id="vagas_total" name="vagas_total" value="{{ old('vagas_total') }}" 
                           min="1" required>
                    @error('vagas_total')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
